...
export const authService = {
    ...
    revokeToken() {
        return httpService.post(`${authServerUrl}/api/token-revocation`, new TokenRevocationRequest(this._token), true)
            .then(res => {
    ...
    get_token(code) {
        return httpService.post(`${authServerUrl}/api/auth-token`, new TokenRequest(code), true)
            .then(res => {
