...
from handler.schemas import TaskCreateRequest, TaskRequest, TaskCreateResponse, TaskResponse, TaskListResponse, \
...
@app.post('/my-tasks/api/tasks', status_code=HTTP_201_CREATED, response_model=TaskCreateResponse)
...
@app.get('/my-tasks/api/tasks', status_code=HTTP_200_OK, response_model=TaskListResponse)
...
@app.get('/my-tasks/api/tasks/{task_id}', status_code=HTTP_200_OK, response_model=TaskResponse)
...
@app.delete('/my-tasks/api/tasks/{task_id}', status_code=HTTP_204_NO_CONTENT)
...
@app.put('/my-tasks/api/tasks/{task_id}', status_code=HTTP_200_OK, response_model=TaskUpdateStatusResponse)
